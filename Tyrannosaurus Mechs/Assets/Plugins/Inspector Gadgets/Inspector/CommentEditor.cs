...
{
    /// <summary>
    /// Common interface for objects that are displayed by the <see cref="Editor.CommentEditor"/>.
    /// </summary>
...
namespace InspectorGadgets.Editor
{
    ...
    /// <summary>[Editor-Only]
    /// Custom Inspector for <see cref="IComment"/>s.
    /// </summary>
    ...
    public class CommentEditor : UnityEditor.Editor
    {
        ...
        /// <summary>
        /// Draws the <see cref="UnityEditor.Editor.target"/>'s Inspector GUI.
        /// </summary>
