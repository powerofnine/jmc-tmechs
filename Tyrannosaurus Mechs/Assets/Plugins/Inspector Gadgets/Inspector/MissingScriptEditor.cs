...
namespace InspectorGadgets.Editor
{
    ...
    public class MissingScriptEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorApplication.delayCall += () => DestroyProperly(target, true);
            }
        ...
        /// <summary>
        /// Destroys the 'target' object. If it is an asset, a dialogue box asks the user if they are sure first.
        /// </summary>
