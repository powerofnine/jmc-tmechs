...
namespace InspectorGadgets.Editor
{
    ...
    internal sealed class ComponentEditor : Editor<Component>
    {
        ...
        public static readonly AutoPrefs.EditorBool
            HideScriptProperty = new AutoPrefs.EditorBool(Strings.PrefsKeyPrefix + "HideScriptProperty", true);
    }
    ...
    public abstract class Editor<T> : MissingScriptEditor where T : class
    {
        ...
        /// <summary>The object being inspected (<see cref="UnityEditor.Editor.target"/> casted to T) by the editor currently being drawn.</summary>
        public static T CurrentTarget { get { return Current.Target; } }

        /// <summary>An array of all the objects being inspected (<see cref="UnityEditor.Editor.targets"/> casted to T) by the editor currently being drawn.</summary>
        ...
        protected override void OnEnable()
        {
            ...
            if (target != null && !_HasReflectedTarget)
            {
                ...
                _Inspectables = BaseInspectableAttribute.Gather(target.GetType());
        ...
        public static void DoInspectorGUI()
        {
            ...
            if (current._AfterInspectorGUI != null)
                current._AfterInspectorGUI();
