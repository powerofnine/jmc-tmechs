...
namespace InspectorGadgets.Editor
{
    ...
    public abstract class PropertyVisualiserWindow : EditorWindow
    {
        ...
        /// </summary>
        public SerializedPropertyReference Target { get { return _Target; } }
    ...
    public class Vector3VisualiserWindow : PropertyVisualiserWindow
    {
        ...
        /// The name of the window to use as its title.
        /// </summary>
        protected override string WindowName { get { return "Vector3 Visualiser"; } }
        ...
        {
            return Target.Property.propertyType == SerializedPropertyType.Vector3;
        }
    ...
    public class Vector2VisualiserWindow : PropertyVisualiserWindow
    {
        ...
        /// The name of the window to use as its title.
        /// </summary>
        protected override string WindowName { get { return "Vector2 Visualiser"; } }
        ...
        protected override bool ValidateTarget()
        {
            return Target.Property.propertyType == SerializedPropertyType.Vector2;
        }
    ...
    public class FloatVisualiserWindow : PropertyVisualiserWindow
    {
        ...
        /// The name of the window to use as its title.
        /// </summary>
        protected override string WindowName { get { return "Float Visualiser"; } }
        ...
        protected override bool ValidateTarget()
        {
            return Target.Property.propertyType == SerializedPropertyType.Float;
        }
