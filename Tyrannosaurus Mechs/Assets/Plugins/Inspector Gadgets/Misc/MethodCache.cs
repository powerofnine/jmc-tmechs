...
namespace InspectorGadgets.Editor
{
    ...
    public static class MethodCache
    {
        ...
        public static readonly MethodCache<Action> AfterInspectorGUI = "AfterInspectorGUI";
        public static readonly MethodCache<Action> OnInspectorGUI = "OnInspectorGUI";

        public delegate bool OverridePropertyGUIMethod(UnityEditor.SerializedProperty property, GUIContent label);
        public static readonly MethodCache<OverridePropertyGUIMethod> OverridePropertyGUI = "OverridePropertyGUI";

        public delegate void OnPropertyContextMenuMethod(UnityEditor.GenericMenu menu, UnityEditor.SerializedProperty property);
        public static readonly MethodCache<OnPropertyContextMenuMethod> OnPropertyContextMenu = "OnPropertyContextMenu";
    ...
    public sealed class MethodCache<TDelegate> where TDelegate : class
    {
        ...
        {
            return new MethodCache<TDelegate>(name);
        }
        ...
        {
            MethodInfo method;
            if (!TypeToMethod.TryGetValue(type, out method))
            {
