...
{
    /// <summary>
    /// A <see cref="Vector4"/> which uses nullable floats.
    /// </summary>
    public sealed class NullableVector4
    {
        ...
        public float? this[int i]
        {
            ...
            set
            {
                switch (i)
                {
                    ...
                    default: throw new System.Exception("Unexpected Case");
                }
            }
        }
        ...
        /// <summary>Constructs a new <see cref="NullableVector4"/> with all components null.</summary>
        public NullableVector4() { }

        /// <summary>Constructs a new <see cref="NullableVector4"/> with the specified components.</summary>
        ...
        /// <summary>Constructs a new <see cref="NullableVector4"/> with each of its components set the same as the specified 'value'.</summary>
        ...
        /// <summary>Constructs a new <see cref="NullableVector4"/> using the first 4 elements of the specified array as its components.</summary>
        ...
        {
            if (componentCount <= 0)
                throw new System.ArgumentException("componentCount");
        ...
        public static implicit operator NullableVector4(Vector2 vector)
        {
            return new NullableVector4(vector);
        }

        /// <summary>Returns a new <see cref="NullableVector4"/> with each of its components set the same as the specified 'vector'.</summary>
        public static implicit operator NullableVector4(Vector3 vector)
        {
            return new NullableVector4(vector);
        }

        /// <summary>Returns a new <see cref="NullableVector4"/> with each of its components set the same as the specified 'vector'.</summary>
        public static implicit operator NullableVector4(Vector4 vector)
        {
            return new NullableVector4(vector);
        }
