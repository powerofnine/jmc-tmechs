...
namespace InspectorGadgets
{
    ...
    public static partial class IGUtils
    {
        ...
        {
            return DeepToString(collection, Environment.NewLine);
        }
        ...
        {
            return DeepToString(enumerator, Environment.NewLine);
        }
        ...
        public static void GetMinMaxValueEstimate(this AnimationCurve curve, out float min, out float max, int sampleResolution = 10)
        {
            ...
            float start;
            keys.GetStartEndValue(out start, out max);
            if (start > max)
            {
                min = max;
                max = start;
        ...
        {
            return curve.keys.IsNormalized();
        }
        ...
        public static bool IsNormalized(this Keyframe[] keys)
        {
            ...
            keys.GetStartEndTime(out startTime, out endTime);

            float startValue, endValue;
            keys.GetStartEndValue(out startValue, out endValue);
        ...
        public static AnimationCurve FlipHorizontal(this AnimationCurve curve)
        {
            ...
            float start, end;
            keys.GetStartEndTime(out start, out end);
        ...
        public static AnimationCurve FlipVertical(this AnimationCurve curve)
        {
            ...
            float min, max;
            curve.GetMinMaxKeyValue(out min, out max);
        ...
        public static AnimationCurve ExtendMirrorred(this AnimationCurve curve)
        {
            ...
            keys.GetMinMaxKeyValue(out minValue, out maxValue);
        ...
        public static string GetDescription(this AnimationCurve curve)
        {
            ...
            return string.Concat(
                "AnimationCurve (Keys: ", keys.Length.ToString(),
                ", Time: ", startTime.ToString(), " to ", endTime.ToString(),
                ", Value: ", startValue.ToString(), " to ", endValue.ToString(), ")");
        }
        ...
        public static Component ProgressiveSearch(GameObject gameObject, Type componentType)
        {
            ...
            component = Object.FindObjectOfType(componentType) as Component;
            if (component != null)
                return component;
        ...
        /// <summary>
        /// Tries various search methods until it finds something: first GetComponent, then GetComponentsInParent,
        /// then GetComponentsInChildren, then FindObjectsOfType.
        /// <para></para>
        ...
        public static Component ProgressiveSearch(GameObject gameObject, Type componentType, string nameHint)
        {
            ...
            component = GetBestComponent(gameObject.GetComponentsInParent(componentType), nameHint);
            if (component != null)
                return component;

            component = GetBestComponent(gameObject.GetComponentsInChildren(componentType), nameHint);
            if (component != null)
                return component;

            component = GetBestComponent(Object.FindObjectsOfType(componentType), nameHint) as Component;
            if (component != null)
                return component;
        ...
        public static Component GetComponentInHierarchy(GameObject gameObject, Type componentType, string nameHint)
        {
            ...
            int score;
            var component = GetBestComponent(gameObject.GetComponentsInParent(componentType), nameHint, out score);
            if (bestScore > score)
            {
            ...
            component = GetBestComponent(gameObject.GetComponentsInChildren(componentType), nameHint, out score);
            if (bestScore > score)
            {
                bestComponent = component;
            }
        ...
        /// </summary>
        public static T GetBestComponent<T>(T[] objects, string nameHint, out int score) where T : Object
        {
            score = int.MaxValue;
        ...
        /// See also: <see cref="CalculateLevenshteinDistance"/>.
        /// </summary>
        public static T GetBestComponent<T>(T[] objects, string nameHint) where T : Object
        {
            int score;
            return GetBestComponent(objects, nameHint, out score);
        }
        ...
        /// then GetComponentInChildren, then FindObjectOfType.
        /// </summary>
        public static T ProgressiveSearch<T>(GameObject gameObject) where T : Component
        {
            T component;
