...
namespace InspectorGadgets
{
    ...
    public abstract class StaticLazyStack<T> where T : StaticLazyStack<T>, new()
    {
        ...
        /// </summary>
        /// <remarks>
        /// Not an actual Stack because that class is in System.dll which isn't otherwise needed.
        /// </remarks>
        ...
        /// <summary>
        /// Increments the <see cref="StackHeight"/>, ensures that an element exists at the last index and returns it.
        /// </summary>
            ...
            else
            {
                ...
                if (StackHeight > MaxHeight)
                    Debug.LogWarning("StaticLazyStack<" + typeof(T).Name + ">.StackHeight" +
                        ...
                        ". Please ensure that you Remove as many items as you Add and increase the MaxHeight if necessary.");
            }
        ...
        /// <summary>
        /// Decrements the <see cref="StackHeight"/>.
        /// </summary>
        ...
        where TStack : SimpleStaticLazyStack<TStack, TValue>, new()
    {
        ...
        /// <summary>
        /// The <see cref="CurrentValue"/> from before this stack element was activated.
        /// </summary>
        public TValue PreviousValue { get; private set; }

        /// <summary>
        /// The <typeparamref name="TValue"/> being controlled by this stack.
        /// </summary>
